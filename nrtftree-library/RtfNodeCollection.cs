...
namespace Net.Sgoliver.NRtfTree
{
    namespace Core
    {
        ...
        public class RtfNodeCollection : CollectionBase
        {
            ...
            /// <returns>Indice del nodo buscado. Devolver?el valor -1 en caso de no encontrarse el nodo dentro de la colección.</returns>
            ...
            /// </summary>
            /// <param name="node">Nodo a buscar en la colección.</param>
            /// <param name="startIndex">Posición dentro de la colección a partir del que se buscar?</param>
            /// <returns>Indice del nodo buscado. Devolver?el valor -1 en caso de no encontrarse el nodo dentro de la colección.</returns>
