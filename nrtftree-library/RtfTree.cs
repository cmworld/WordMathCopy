...
namespace Net.Sgoliver.NRtfTree
{
    namespace Core
    {
        ...
        public class RtfTree
        {
            ...
            /// <summary>
            /// Devuelve la tabla de códigos con la que est?codificado el documento RTF.
            /// </summary>
            /// <returns>Tabla de códigos del documento RTF. Si no est?especificada en el documento se devuelve la tabla de códigos actual del sistema.</returns>
            ...
            /// <param name="showNodeTypes">Indica si se mostrar?el tipo de cada nodo del árbol.</param>
