...
namespace Net.Sgoliver.NRtfTree
{
    namespace Core
    {
        ...
        public class RtfMerger
        {
            ...
            /// <param name="iNdIndex">Índice (dentro del grupo padre) del nodo texto que se est?procesando.</param>
            ...
            /// <param name="intPlaceHolderNodePos">Posición de la etiqueta que se va a reemplazar dentro del nodo texto que se est?procesando.</param>
            ...
            {
                //Si el documento a insertar no est?vacío
            ...
            /// <param name="intCurrIndex">Índice en el que se insertar?el nuevo árbol dentro del grupo base.</param>
